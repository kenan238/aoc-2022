# day 12 - stressfull, because of school
...
def part1():
    ...
    print('Part 1', get_dist(grid, start, end))
...
def part2():
    ...
    print('Part 2', min(filter(lambda x: x is not None, [get_dist(grid, a, end) for a in possible_start])))
